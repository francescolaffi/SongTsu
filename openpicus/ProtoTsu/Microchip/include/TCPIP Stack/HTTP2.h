...
/****************************************************************************
  ...
  ***************************************************************************/
	...
	typedef enum
	{
		...
		#if defined STACK_USE_WEBSOCKETS
		SM_HTTP_INIT_WEBSOCKET,			// initiate websocket connection
		SM_HTTP_PROC_WEBSOCKET,			// proceed websocket connection
		SM_HTTP_CLOSE_WEBSOCKET,		// close websocket connection
		#endif
